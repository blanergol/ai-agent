...
// TestOTelArtifactSinkSetsLangfuseTraceAndObservationIOForAgentArtifacts verifies
// root agent artifacts are propagated to Langfuse trace and observation I/O fields.
...
// TestOTelArtifactSinkSetsObservationIOForLLMArtifactsOnly verifies prompt/response
// artifacts still enrich observation I/O for non-root spans without overriding trace I/O.
...
// TestOTelArtifactSinkSetsTraceOutputForRunResultState verifies run-result state
// artifact backfills trace output for non-finalized agent runs.
