...
import "github.com/blanergol/agent-core/pkg/cache"

// providerOptions хранит внутренние опции инициализации LLM-провайдера.
type providerOptions struct {
	cacheBackplane cache.Backplane
	modelPrices    map[string]ModelPrice
}

// ModelPrice задает стоимость токенов за 1M для fallback-расчета стоимости в Langfuse.
type ModelPrice struct {
	InputPer1M  float64
	OutputPer1M float64
}

// ProviderOption задает дополнительную runtime-настройку LLM provider.
...
// WithModelPrices задает fallback-стоимость по моделям для Langfuse cost details.
