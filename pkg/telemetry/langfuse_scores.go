...
// langfuseScoreSink отправляет score-события в HTTP API Langfuse.
...
// langfuseScoreRequest задает формат payload для POST /api/public/scores.
...
// newLangfuseScoreSink создает sink оценок и настраивает endpoint/auth для Langfuse.
...
// Save отправляет одно score-событие в Langfuse, если входные данные валидны.
...
// traceIDFromContext извлекает trace-id активного OTel span из контекста.
