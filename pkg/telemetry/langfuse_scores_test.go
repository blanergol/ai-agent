...
// TestLangfuseScoreSinkSendsScoreForActiveTrace проверяет отправку score при активном trace-id.
...
// TestLangfuseScoreSinkSkipsWhenTraceIDMissing проверяет, что без trace-id запрос не отправляется.
...
// TestTraceIDFromContext проверяет извлечение trace-id из пустого и трассируемого контекста.
