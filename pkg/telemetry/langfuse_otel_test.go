...
// TestSessionOTelAttrsIncludesLangfuseSessionAndUserIDs проверяет,
// что для сессии/пользователя выставляются нужные Langfuse-атрибуты.
...
// TestSessionOTelAttrsOmitsUserAttrsWhenMissing проверяет,
// что при пустом user-sub идентификаторы пользователя не добавляются.
...
// otelAttrMap преобразует OTel-атрибуты в map для удобных ассертов в тестах.
